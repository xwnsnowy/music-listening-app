  ...
  const MediaItem: React.FC<MediaItemProps> = ({
    ...
    return (
      <div
        onClick={handleClick}
        className={twMerge(
          "flex w-full z-50 items-center justify-start px-4 py-2 rounded-md bg-neutral-400/10 drop-shadow-md gap-4 cursor-pointer opacity-70 hover:opacity-100 font-circular",
          className
        )}
      >
